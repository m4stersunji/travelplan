/**
 * Typed client for travelplan-api.
 * In production, NEXT_PUBLIC_API_URL is set to https://travelplan-api.<subdomain>.workers.dev.
 * Falls back to relative /api in dev so local Next.js routes still work.
 */

const API_URL =
  process.env.NEXT_PUBLIC_API_URL ||
  "https://travelplan-api.nattawatsun01.workers.dev";
